...
def home():
    ...
    <body>
        ...
        <!-- ФУТЕР -->
        <div style="position: fixed; bottom: 0; left: 0; width: 100%; text-align: center; padding: 20px 0; color: #718096; border-top: 1px solid #e2e8f0; background: white; z-index: 1000;">
            <div style="margin-bottom: 10px;">
                <a href="/terms" style="color: #718096; text-decoration: none; margin: 0 10px; font-size: 12px;">Пользовательское соглашение</a>
                <a href="/privacy" style="color: #718096; text-decoration: none; margin: 0 10px; font-size: 12px;">Политика конфиденциальности</a>
                <a href="/offer" style="color: #718096; text-decoration: none; margin: 0 10px; font-size: 12px;">Публичная оферта</a>
                <a href="mailto:support@docscan.example.com" style="color: #718096; text-decoration: none; margin: 0 10px; font-size: 12px;">Техподдержка</a>
            </div>
